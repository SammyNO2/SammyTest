...
namespace CovidPayTracking.Models.Mapper
{
    public static class MapFromModel
    {
        ...
        public static PayDecisionViewModel MapPDViewModel(PayDecision payDecision)
        {
            ...
            pd.COVIDTestPTOAdjustment = payDecision.COVIDTestPTOAdjustment;
            return pd;
        }
        ...
        public static EmployeeMeritSTDElectionViewModel MapMEViewModel (EmployeeSTDElection ese, EmployeeMerit em)
        {
            ...
            emse.SSN = ese.SSN;
            emse.Status = ese.Status;
            emse.StructureGroup = ese.StructureGroup;
            emse.STDElection = ese.STDElection;
            emse.STDElectionPercent = ese.STDElectionPercent;
            emse.STDReview = ese.STDReview;
            emse.STDEffectiveDt = ese.STDEffectiveDt;
            emse.STD2Election = ese.STD2Election;
            emse.STD2ElectionPercent = ese.STD2ElectionPercent;
            emse.TotalSTDElectionPercent = ese.TotalSTDElectionPercent;
            emse.BenefitStatus = ese.BenefitStatus;
        ...
        public static CovidTestViewModel MapCovidTestViewModel (CovidTest ct)
        {
            var ctvm = new CovidTestViewModel();
            ctvm.ID = ct.ID;
            ctvm.EmployeeNumber = ct.EmployeeNumber;
            ctvm.EmployeeFirstName = ct.EmployeeFirstName;
            ctvm.EmployeeLastName = ct.EmployeeLastName;
            ctvm.Resulted = ct.RESULTED;
            ctvm.Result = ct.RESULT;
            ctvm.Source = ct.Source;
            return ctvm;
        }

        public static PayPeriodViewModel MapPayPeriodViewModel (PayPeriod pp)
        {
            var ppvm = new PayPeriodViewModel();
            ppvm.PayPeriodNum = pp.PayPeriodNum;
            ppvm.StartDate = pp.StartDate;
            ppvm.EndDate = pp.EndDate;
            ppvm.PayDate = pp.PayDate;
            return ppvm;
        }
